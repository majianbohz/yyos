...
kernel.elf : yy_kernel/*.s yy_kernel/*.c  common/*.s common/*.c
	...
	$(LD)  $(LDFLAGS_KERNEL)  -o $@  kernel.o  print.o descriptor.o descriptor_manage.o interrupt.o interrupt_manage.o convert.o port.o process.o process_manage.o memcpy.o delay.o  # kernel.o must put first, affect binary file out
